...
_ML_SCRIPTS = _ROOT / "ML_backend" / "python-ml" / "retail" / "demand_forecast"
_BACKEND = _ROOT / "backend"

CODE_FILE_MAP: dict[str, dict] = {
    "train_model": {
        "path": _ML_SCRIPTS / "retail_demand_forecast_main.py",
        "label": "ML Trainer",
        "description": "Main demand forecast pipeline — model selection, training and scoring across all algorithms",
    },
    "train_tune": {
        "path": _ML_SCRIPTS / "train_tune_model.py",
        "label": "Train & Tune",
        "description": "Hyperparameter tuning and cross-validation logic for demand forecast models",
    },
    "data_prep": {
        "path": _ML_SCRIPTS / "data_prep.py",
        "label": "Data Prep",
        "description": "Data preparation and feature engineering for retail demand time-series",
    },
    "feature_selection": {
        "path": _ML_SCRIPTS / "feature_selection.py",
        "label": "Feature Selection",
        "description": "Feature importance and selection logic for demand forecast inputs",
    },
    "storage": {
    ...
    "ml_service": {
        ...
        "label": "ML Service",
        "description": "Bridges FastAPI routes to Python ML training scripts via subprocess",
    },
    "schema": {
...
def list_algorithms():
    """Read algorithm names directly from the demand forecast main script."""
    train_path = _ML_SCRIPTS / "retail_demand_forecast_main.py"
