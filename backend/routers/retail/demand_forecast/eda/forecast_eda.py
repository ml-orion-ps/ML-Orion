...
SKU_COLS        = ["Style Code","P4 Style", "style code"]
STORE_COLS      = ["store"]
WEEK_COLS       = ["Week_Date"]
UNITS_COL       = "Net Shipped"
NET_SALES_COL   = "Net Invoiced (USD)"
GROSS_SALES_COL = "Net Shipped"
REVENUE_COLS    = ["Net Invoiced (USD)"]
# DISCOUNT_COL    = "discount_value"
PRICE_COL       = "Final Retail Price"
BASE_PRICE_COL  = "Final Cost"
CATEGORY_COL    = "P3 Category"
BRAND_COL       = "brand"
...
def run(df: pd.DataFrame) -> dict:
    ...
    if sku_col and units_col:
        df[units_col] = df[units_col].astype(float)
    ...
    final_return_json = {
        "usecase": "retail_demand_forecast",
        "overview": overview,
...
# df = pd.read_csv("C:/Users/ShrutiAgrawal/OneDrive - Polestar Solutions & Services India Private Limited/Desktop/Orion/ML-Orion/ML_backend/python-ml/retail/demand_forecast/SUBSET_base_data_demand_forecast_vf2.csv")
# result = run(df)
# print(result)
