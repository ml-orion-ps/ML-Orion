    ...
    extend: {
      ...
      colors: {
        ...
        risk: {
          ...
          "high-foreground": "hsl(var(--risk-high-foreground) / <alpha-value>)",
          medium: "hsl(var(--risk-medium) / <alpha-value>)",
          "medium-foreground": "hsl(var(--risk-medium-foreground) / <alpha-value>)",
          low: "hsl(var(--risk-low) / <alpha-value>)",
          "low-foreground": "hsl(var(--risk-low-foreground) / <alpha-value>)",
        },
        copper: {
